...
namespace Transparent_Form
{
    public partial class ManageCourseForm : Form
    {
        ...
        private void button_Update_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("ต้องการข้อมูลหลักสูตร", "Field Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            { 
                ...
                if (course.UpdateCourse(id, cName, chr, desc))
                {
                    ...
                    MessageBox.Show("ปรับปรุงหลักสูตรเรียบร้อยแล้ว", "Update Course", MessageBoxButtons.OK, MessageBoxIcon.Information);

                }
                else
                {
                    MessageBox.Show("ข้อผิดพลาด - ไม่สามารถแก้ไขรายวิชา", "Update Course", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
        ...
        private void button_delete_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("ต้องการรหัสวิชา", "Field Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                try
                {
                    ...
                    if (course.deletCourse(id))
                    {
                        showData();
                        button_clear.PerformClick();
                        MessageBox.Show("รายวิชาถูกลบแล้ว", "Removed Course", MessageBoxButtons.OK, MessageBoxIcon.Information);
